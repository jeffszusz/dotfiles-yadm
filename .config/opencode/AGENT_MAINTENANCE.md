...
For how-to guidance on maintaining agents, skills, and OpenCode config, load the `opencode-maintenance` skill.

## Alternates Tracking

Current files using yadm alternates. Keep this list up to date when adding or removing agents.
